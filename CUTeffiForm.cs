...
namespace Cuteffi_rebuild
{
    public partial class CUTeffiForm : Form
    {
        ...
        Graphics originalworkpiece, cutworkpiece;
        Brush Blackbrush, Bluebrush, Whitebrush;
        Size CutEdge1, CutEdge2;
        Point CutLocation1, CutLocation2;
        Rectangle[] CutRectangle = new Rectangle[50];
        int k = 0;
        ...
        private void LoadDefult()
        {
            ...
            OX.Text = Settings1.Default.WorkpieceX;
            OY.Text = Settings1.Default.WorkpieceY;
            OZ.Text = Settings1.Default.WorkpieceZ;
            CZ.Text = Settings1.Default.CuttingDepth;
            CX.Text = Settings1.Default.CuttingWidth;
        ...
        private void CUTeffiForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            Settings1.Default.WorkpieceX = OX.Text;
            Settings1.Default.WorkpieceY = OY.Text;
            Settings1.Default.WorkpieceZ = OZ.Text;
            Settings1.Default.CuttingDepth = CZ.Text;
            Settings1.Default.CuttingWidth = CX.Text;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                double CuttingDepth = Convert.ToDouble(CZ.Text);
                ...
                double Xhalflength = Convert.ToDouble(OX.Text) / 2;
                double Yhalflength = Convert.ToDouble(OY.Text) / 2;
                double CuttingWidth = Convert.ToDouble(CX.Text);
        ...
        private void pictureBox3_Paint(object sender, PaintEventArgs e)
        {
            if (k == 1)
            {
                originalworkpiece = e.Graphics;
                originalworkpiece.FillRectangle(Blackbrush, new Rectangle(0, 0, Convert.ToInt32(OX.Text), Convert.ToInt32(OZ.Text)));
            }
            else if (k > 1)
            {
                originalworkpiece = e.Graphics;
                cutworkpiece = e.Graphics;
                originalworkpiece.FillRectangle(Blackbrush, new Rectangle(0, 0, Convert.ToInt32(OX.Text), Convert.ToInt32(OZ.Text)));
                for (int i = 0; i < k; i++)
                {
                    cutworkpiece.FillRectangle(Whitebrush, CutRectangle[i]);
                }
            }
        }
        ...
        private void pictureBox4_Paint(object sender, PaintEventArgs e)
        {
            if (k == 1)
            {
                originalworkpiece = e.Graphics;
                cutworkpiece = e.Graphics;
                CutEdge1 = new Size(Convert.ToInt32(Convert.ToDouble(CX.Text) * 13), Convert.ToInt32(Convert.ToDouble(CZ.Text)));
                CutLocation1 = new Point(Convert.ToInt32(NX.Text), Convert.ToInt32(NZ.Text));
                CutRectangle[k - 1] = new Rectangle(CutLocation1, CutEdge1);
                originalworkpiece.FillRectangle(Blackbrush, new Rectangle(0, 0, Convert.ToInt32(OX.Text), Convert.ToInt32(OZ.Text)));
                cutworkpiece.FillRectangle(Bluebrush, CutRectangle[k - 1]);
            }
            else if (k > 1)
            {
                originalworkpiece = e.Graphics;
                cutworkpiece = e.Graphics;
                originalworkpiece.FillRectangle(Blackbrush, new RectangleF(0, 0, Convert.ToInt32(OX.Text), Convert.ToInt32(OZ.Text)));
                for (int i = 0; i < k; i++)
                {
                    cutworkpiece.FillRectangle(Whitebrush, CutRectangle[i]);
                }
                CutEdge2 = new Size(Convert.ToInt32(Convert.ToDouble(CX.Text) * 13), Convert.ToInt32(Convert.ToDouble(CZ.Text)));
                CutLocation2 = new Point(Convert.ToInt32(NX.Text), Convert.ToInt32(NZ.Text));
                CutRectangle[k - 1] = new Rectangle(CutLocation2, CutEdge2);
                cutworkpiece.FillRectangle(Bluebrush, CutRectangle[k - 1]);
            }
        }
        ...
        {
            NX.Text = e.X.ToString();
            NZ.Text = e.Y.ToString();
            this.pictureBox4.Refresh();
        }
        ...
        private void CZ_TextChanged(object sender, EventArgs e)
        {
            this.pictureBox4.Refresh();
        }
        ...
        private void NX_TextChanged(object sender, EventArgs e)
        {
            this.pictureBox4.Refresh();
        }

        private void NZ_TextChanged(object sender, EventArgs e)
        {
            this.pictureBox4.Refresh();
        }
